...
/* ObjectTesting coverage for NSFont+GB: a font asked for by a name this
...
int main(void)
{
  @autoreleasepool
    {
      /* The installed GershwinBehaviors bundle (loaded directly, or by the
       * Eau theme as a fallback) would swizzle NSFont a second time; test
       * only the category linked into this tool. */
